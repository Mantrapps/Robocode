		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="#edit">Edit</a>
					<ul class="dropdown-menu">
					<!--  
						<li><a href="Edit_Robot.jsp">Robot</a></li>
					-->
					    <li><a href="RobotEdit.jsp">Robot</a></li>
					...
					-->
					    <li><a href="RobotView.jsp">Robot</a></li>
						<li><a href="Ranking.jsp">Ranking</a></li>
						<li><a href="#VUser">User</a></li>
						<li><a href="#VDomain">Domain</a></li>
						<li><a href="#VRole">Role</a></li>
					</ul></li>
				<li class="page-scroll"><a href="BattlePlay.jsp">Play Battle!</a></li>
