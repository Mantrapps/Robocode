		...
		<form action="playBattle" method="post" id="playBattleForm">
			<%
				try {
					...
					//String connectionUrl = "jjdbc:sqlserver://robo.database.windows.net:1433;database=robocode;user=robocode@robo;password=robo.123;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30"; 
					//Connection conn = DriverManager.getConnection(connectionUrl,"usrname","pwd");
					String connectionURL = "jdbc:sqlserver://robo.database.windows.net:1433;database=robocode;user=robocode@robo;password=robo.123;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;";
									Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
					...
					rs = st.executeQuery("select Robot_Name from dbo.robot");
			%>
