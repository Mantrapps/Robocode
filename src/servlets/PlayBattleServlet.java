...
public class PlayBattleServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		for (int i = 0; i< robots.length; i++){
			...
			String  packageName =  robots[i].substring(0, robots[i].indexOf("."));
			String robotName = robots[i].substring(robots[i].indexOf(".") + 1 , robots[i].length() );
			...
			String selectString="SELECT RobotCode from robot where packageID='"+ packageName +"' and robotID='" +robotName+"'"  ;
	        ...
	        System.out.println("Himanshu" + location.getFile().toString());
